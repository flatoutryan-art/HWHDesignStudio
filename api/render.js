// render.js — starts prediction only, returns ID immediately
// Browser polls /api/render-status for completion
module.exports = async function handler(req, res) {
  ...
  const fullPrompt = `Professional interior design photograph of a beautifully renovated ${roomPrompt}, ${stylePrompt}, ${palettePrompt}, HWH Designs premium cabinetry, photorealistic, architectural photography, bright natural lighting, ultra detailed`;
  const negativePrompt = 'cartoon, sketch, drawing, illustration, blurry, low quality, distorted, watermark, text';
  ...
  try {
    ...
    // Return prediction ID immediately — browser will poll for status
