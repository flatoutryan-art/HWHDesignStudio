...
### Step 4 — Add your Anthropic API Key (REQUIRED for AI to work)
...
6. Click **Save**
7. Go to **Deployments** → click the three dots on your latest deploy → **Redeploy**

The AI will now be live. The green 🟢 badge on step 3/4 confirms it's working.
